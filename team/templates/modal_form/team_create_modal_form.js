(function () {
  ...
  // Show MyTeam modal when the button is clicked
  document.getElementById('myTeamButton').addEventListener('click', () => {
    const myTeamModalEl = document.getElementById('myTeamModal');
    const myTeamModal = new bootstrap.Modal(myTeamModalEl);
    myTeamModal.show();
  });
})();